...
(async () => {
  ...
  await page
    ...
    .click();
  await page
    .locator("#t1 > table > tr:nth-child(4) > td:nth-child(22) > button")
    .click();
  await page
  ...
  await page
    ...
    .click();
  await page
    .locator("#t1 > table > tr:nth-child(2) > td:nth-child(8) > button")
    .click();
  await page
    .locator("#t1 > table > tr:nth-child(2) > td:nth-child(6) > button")
    .click();
  ...
  await page
    ...
    .click();
  await page
    .locator("#t1 > table > tr:nth-child(2) > td:nth-child(10) > button")
    .click();
  await page
    .locator("#t1 > table > tr:nth-child(2) > td:nth-child(6) > button")
    .click();
